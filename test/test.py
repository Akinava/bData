...
def test_obj():
    ...
    print 'Object'
    cases = [
        {'value': True,          'data': '\x01\x01\x60\x01'},                    #  0
        {'value': [1],           'data': '\x03\x01\x80\x01\x00\x01'},            # -3
        {'value': {},            'data': '\x02\x00\xa0\x00'},                    # -2
        {'value': [],            'data': '\x02\x00\x80\x00'},                    # -2
        {'value': [0, 1],        'data': '\x03\x02\x81\x02\x00\x00\x01'},        # -1
        {'value': {0: 0},        'data': '\x04\x02\xa0\x01\x00\x00\x00\x00'},    #  0
        {'value': {0: []},       'data': '\x05\x01\xa0\x01\x00\x80\x00\x00'},    #  1
        {'value': {0: 0, 1: 0},  'data': '\x04\x04\xa3\x02\x00\x00\x00\x00\x01\x00'},          #  6
        {'value': [1, 'a', 3.5], 'data': '\x06\x04\x80\x03\x00\x40\x01\x20\x01\x61\xff\x23'},  #  1
        {'value': [1, 20, 3],    'data': '\x03\x03\x81\x03\x00\x01\x14\x03' },                 #  2
        {'value': [1, 20, 3, -2],  'data': '\x03\x04\x81\x04\x00\x01\x14\x03\xfe'},            #  5
        {'value': [1, 20, 3, '1'], 'data': '07048004000000400101140331'.decode('hex')},        #  2
        {'value': [1, 20, 3, '1', '0232'], 'data': '09088005000000400140040114033130323332'.decode('hex')},                                                  #  4
        {'value': [1, 20, 3, '1', '0232', 2, 3, {1:1, 4: 'q'}], 'data': '110e8008000000400140040000a102000040010114033130323332020301010471'.decode('hex')}, # 16
        {'value': 'qwertyqwerty', 'data': '020c400c717765727479717765727479'.decode('hex')},   # -2
        {'value': 0,              'data': '\x01\x01\x00\x00'},                                 # -3
        {'value': 1000,           'data': '\x01\x02\x08\x03\xe8'},                             # -1
        {'value': 0x7fffffff,     'data': '0104107fffffff'.decode('hex')},                     #  3
        {'value': 100000.0,       'data': '\x01\x02\x20\x05\x01'},                             #  3
        {'value': 11.01,          'data': '\x01\x03\x28\xfe\x04\x4d'},                         # -1
        {'value': [11.01],        'data': '0303800128fe044d'.decode('hex')},                   # -1
        {'value': [11.01, 5.03],  'data': '0306810228fe044dfe01f7'.decode('hex')},             # -2
        {'value': [11.01, 5.03, 80.99], 'data': '0309810328fe044dfe01f7fe1fa3'.decode('hex')}, #  6
    ]
